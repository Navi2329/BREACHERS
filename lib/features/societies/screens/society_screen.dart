...
class SocietyScreen extends ConsumerWidget {
  final String name;
  const SocietyScreen({super.key, required this.name});
  ...
  void joinCommunity(WidgetRef ref, Society society, BuildContext context) {
    ref.read(societyProvider.notifier).joinSociety(society, context);
  }
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      body: ref.watch(societybynameProvider(name)).when(
            data: (community) => NestedScrollView(
              ...
              body: ref.watch(getSocietyPostsProvider(name)).when(
                    data: (data) {
