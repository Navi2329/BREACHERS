...
class PostCard extends ConsumerWidget {
  ...
  void navigateToSociety(BuildContext context) {
    Routemaster.of(context).push('/r/${post.societyName}');
  }
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Row(
                                  children: [
                                    GestureDetector(
                                      onTap: () => navigateToSociety(context),
                                      child: CircleAvatar(
                                        backgroundImage: NetworkImage(
                                          post.societyProfilePic,
                                        ),
                                        radius: 16,
                                      ),
                                    ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                ref.watch(societybynameProvider(post.societyName)).when(
                                      data: (data) {
